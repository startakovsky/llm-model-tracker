...
Reference model: **GLM-5.2** (daily driver, $0.90+$2.86/M on OpenRouter, 82.8% SWE-bench, 81.0 Terminal-Bench)
...
|---|---|---|---|---|---|---|---|---|---|
| [GLM-5.2](glm-5.2.md) | Z.ai | 753B | 40B | 1M | $0.90+$2.86/M | Q2: 254GB | Frontier coding (82.8% SWE-bench) | **Reference** — best-in-class agentic (81.0 Terminal-Bench) | [HN](https://news.ycombinator.com/item?id=48639840) |
