...
| [GLM-5.2](open/glm-5.2.md) | Z.ai | Frontier | 1M | $0.92+$2.90/M | 2026-06 | Large | Reference model. 753B/40B MoE. 82.8% SWE-bench. Price slightly down to $0.924/$2.904 |
...
| [Qwen3-235B-A22B-Instruct](open/qwen3-235b-a22b-2507.md) | Alibaba | Self-hostable | 262K | $0.09+$0.55/M | 2026-07 | Yes | 234B/7B MoE. Completion price up from $0.10 |
...
| [Nemotron 3 Super](open/nemotron-3-super-120b-a12b.md) | NVIDIA | Self-hostable | 1M | $0.08+$0.45/M | 2026-06 | Yes | 120B/12B hybrid Mamba-Transformer MoE. 1M ctx. Fully open weights/datasets/recipes |
| [Llama 3.3 70B](open/llama-3.3-70b-instruct.md) | Meta | Lightweight | 131K | $0.10+$0.32/M | 2025-12 | Yes | 70B dense |
| [Gemma 4 31B-IT](open/gemma-4-31b-it.md) | Google | Lightweight | 262K | $0.06+$0.35/M | 2026-04 | Yes | 31B dense multimodal. Prompt price halved to $0.06 |
...
| [DeepSeek V4 Flash](open/deepseek-v4-flash.md) | DeepSeek | Self-hostable | 1M | $0.09+$0.18/M | 2026-06 | Yes | 290B/13.5B MoE. 1M ctx. Price up ~17% |
| [Qwen3.5-9B](open/qwen3.5-9b.md) | Alibaba | Lightweight | 262K | $0.10+$0.15/M | 2026-03 | Yes | 9B dense |
| [GPT-OSS-120B](open/gpt-oss-120b.md) | OpenAI | Self-hostable | 131K | $0.03+$0.15/M | 2026-05 | Yes | 120B/5B MoE. Price dropped to $0.03/$0.15. Cheapest API |
| [Laguna XS 2.1](open/laguna-xs-2.1.md) | Poolside | Lightweight | 262K | $0.06+$0.12/M | 2026-07 | Yes | 33B/3B MoE coding agent |
| [GPT-OSS-20B](open/gpt-oss-20b.md) | OpenAI | Lightweight | 131K | $0.03+$0.14/M | 2026-05 | Yes | 20B/3B MoE |
