...
Daily-updated tracker of top LLMs. Open and closed source. Last updated: 2026-08-31
...
| 5 | [DeepSeek V4 Pro](open/deepseek-v4-pro.md) | DeepSeek | Frontier | 1M | $1.04+$2.08/M | 2026-06 | 89 | Price up on Aug 24 to $0.5222/$1.0443 (per-token repricing; +32%/+32% from Aug 23) Price up +10%/+10% to $0.573/$1.146 on Aug 25 (continues Aug 24 per-token repricing) [Aug 26] Price up +52%/+52% to $0.870/$1.740 (DeepSeek peak-hour repricing) [Aug 28] Price down -10%/-10% to $0.782/$1.565 (reverts peak-hour bump) [Aug 29] Price down -23%/-23% to $0.60/$1.20 (DeepSeek broad price cut alongside V4 Flash line) [Aug 30] Price down -30%/-30% to $0.417/$0.835 (further DeepSeek broad price cut; now ~70% of list) [Aug 31] Price up +149%/+149% to $1.039/$2.079 (rebounds from Aug 30 low; DeepSeek broad repricing) |
...
| 9 | [Inkling](open/inkling.md) | Thinking Machines | Frontier | 1M | $1.00+$4.05/M | 2026-07 | 85 | Prompt up ~5% to $1.00 on Aug 23 (completion steady $4.05) Price prompt -5% to $0.95 on Aug 25 (completion steady $4.05) [Aug 30] Price prompt +5% to $1.00 (completion steady $4.05; reverts Aug 25) |
| 10 | [Kimi K2.7 Code](open/kimi-k2.7-code.md) | Moonshot AI | Frontier | 262K | $0.66+$3.40/M | 2026-06 | 85 | 1T/32B MoE coding model. Native multimodal. Price down -4%/-3% to $0.67/$3.40 on Aug 13 Price up +6%/+3% to $0.71/$3.50 on Aug 14. Price down -6%/-3% to $0.67/$3.40 on Aug 21 Price trim -1.5% to $0.66/$3.40 on Aug 28 (prompt only) |
...
- [Open-source models (110)](INDEX-OPEN.md)
